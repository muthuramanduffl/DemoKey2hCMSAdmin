...
public partial class adminkey2hcom_AddCustomizationTransaction : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                lbldisplayText.Text = "Edit Customization Transaction ";
                int flatIdValue = 0;
            ...
            else
            {
                ...
                lbldisplayText.Text = "Add Customization Transaction ";
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("view-customization-transaction.aspx");
        }
    }
    ...
    public void FlatFunction()
    {
        ...
        {
            CI.StoreExceptionMessage("add-customization-transaction.aspx", "FlatFunction", ex.Message, "Not Fixed");
        }
    }
        ...
        try
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    ddlDemandType.DataTextField = "CustomizationWork";
    ...
    public static string BindWorkProgressname(int id)
    {
        Key2hCustomisationWorkApproval KCZW = new Key2hCustomisationWorkApproval();
        ClientDashboardError CE = new ClientDashboardError();
        string name = string.Empty;
        try
        {
            DataTable DT = KCZW.ViewAllcustomerapprovalByID(id);
            if (DT != null && DT.Rows.Count > 0)
            {
                name = DT.Rows[0]["CustomizationWork"].ToString();
            }
        }
        catch (Exception ex)
        {
