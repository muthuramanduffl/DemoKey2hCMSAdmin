...
public partial class adminkey2hcom_ViewUser : System.Web.UI.Page
{
    ...
    public void Bind(int pageIndex)
    {
        ...
        {
            CE.StoreExceptionMessage("view-user.aspx", "Repeater1_ItemCommand", ex.Message, "Not Fixed");
        }
    }
    public DataTable Get()
    {
        ...
        {
            CE.StoreExceptionMessage("view-user.aspx", "Get", ex.Message, "Not Fixed");
        }
        return dt;
    }
            ...
            try
            {
                ...
                if (ret == 1)
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                       "Swal.fire({ " +
                       "  title: 'User details has been deleted ', " +
