<%@ Page Title="" Language="C#" MasterPageFile="~/AdminKey2h.master" AutoEventWireup="true" CodeFile="add-kyc-docs1.aspx.cs" Inherits="adminkey2hcom_AddKYCDocs" %>
                                    ...
                                    <div class="row mx-0 margin-top20 mb-4">
                                        ...
                                        <div class="col-sm-4 col-xl-3 pt-4">
                                            ...
                                            <span class="error">
                                                ...
                                                <%--                                                <asp:RequiredFieldValidator ClientIDMode="Static" Display="Dynamic" EnableClientScript="true" SetFocusOnError="true" ControlToValidate="FileUploadOtherDocuments" ValidationGroup="val" ID="RequiredFieldValidator19" runat="server" ErrorMessage="Upload booking documents"></asp:RequiredFieldValidator>--%>
