...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="card-body">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div class="input-icon input-icon-sm right">
                                                        ...
                                                        <asp:TextBox runat="server"  ID="txtCost" MaxLength="10" class="form-control input-sm input-value" autocomplete="off"></asp:TextBox>
                                                    </div>
                                                    <span class="error">
                                                        ...
                                                        <asp:RegularExpressionValidator ClientIDMode="Static" ID="RegularExpressionValidator3" Display="Dynamic" runat="server" ValidationGroup="val" ControlToValidate="txtCost" ValidationExpression="^\d{0,9}$" ErrorMessage="Enter valid cost (only numbers)"></asp:RegularExpressionValidator>
                                                    </span>
                                                </ContentTemplate>
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="ddlCostLabel" EventName="SelectedIndexChanged" />
                            ...
                            <div class="form-group" id="divrptCustomers" clientidmode="Static" runat="server">
                                <div class="form-border margin-top20">
                                    ...
                                    <div class="pt-5">
                                        <h3 style="padding-left: 15px;">Net Amount Payable : Rs. <asp:Label ID="lbltotalamount" CssClass="error-label" ForeColor="#D41111" runat="server" Text=""></asp:Label> </h3> 
                                    </div>
    ...
    <script>
        ...
        document.getElementById('<%= txtCost.ClientID %>').addEventListener('keypress', function (e) {
            if (!/^\d+$/.test(e.key)) {
                e.preventDefault();
            }
        });
