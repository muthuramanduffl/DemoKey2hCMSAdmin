<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="view-notification.aspx.cs" Inherits="adminkey2hcom_ViewBroadcast" %>
        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex pb-2 align-items-left align-items-sm-center flex-column flex-sm-row justify-content-between">
                    <div class="d-flex">
                        <h2 class="text-white mb-0 fw-bold text-uppercase">View Customer Notifications</h2>
                                                ...
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="min-w-150">Flat No</thclass="min-w-120>
                                                            <th>Title</th>
                                                            <th>Content</th>
                                                            <th>Read Status</th>
                                            ...
                                            <itemtemplate>
                                                <tr>
                                                    ...
                                                    <td><div class="view-paragraphs truncate-text"> <%# Eval("Message") %> </div> </td>
                                                      ...
                                                      <td> <%# Convert.ToInt32(Eval("ReadStatus")) == 1 ? "<div class=''>Read</div>" :"<div class=''>UnRead </div> " %></td>
                                                    <td><%# Eval("CreatedDate", "{0:dd MMM yyyy hh:mm:ss tt}") %></td>
                                                </tr>
                                                </tbody>
                                            </itemtemplate>
                                            <footertemplate>
