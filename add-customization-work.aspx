                                        ...
                                        <div class="col-sm-4 col-xl-3 pt-3">
                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <span class="error">
                                                        <asp:RequiredFieldValidator ClientIDMode="Static" Display="Dynamic" ControlToValidate="ddlWorkList" ValidationGroup="val" ID="RequiredFieldValidator1" runat="server" ErrorMessage="Select work list"></asp:RequiredFieldValidator>
                                                    </span>
                                                </ContentTemplate>
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="btnAdd" EventName="click" />
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel8" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div class="input-icon input-icon-sm right">
                                                        ...
                                                        <asp:TextBox runat="server" ID="txtAmount" MaxLength="10" ReadOnly="true" EnableViewState="true" class="form-control input-sm input-value" autocomplete="off"></asp:TextBox>
                                                    </div>
                                                    <span class="error">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <label class="lbltitle"><%# Eval("WorkTitlenew") %></label></td>
                                                            <td>
