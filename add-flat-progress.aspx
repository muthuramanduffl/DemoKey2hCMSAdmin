...
`,
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function addNewFileUploadRow() {
                ...
                if (rowCounter < maxRows) {
                    ...
                    <span class="handle-file-request d-block pt-1">(max file size of 1500 KB)</span>
                    <small class="file-error text-danger d-none">Image size must be under 1500 KB</small>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const maxFileSize = 1500 * 1024; // 500 KB in bytes
            let screensrc = null;
