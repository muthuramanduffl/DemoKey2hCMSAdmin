...
public partial class Adminkeyhcombulkuploadblock : System.Web.UI.Page
{
    ...
    public void Bind(string id)
    {
        ...
        {
            CE.StoreExceptionMessage("bulkuploadblock.aspx", "Bind", ex.Message, "Not Fixed");
        }
    }
    ...
    public void Bindprojects()
    {
        ...
        {
            CE.StoreExceptionMessage("bulkuploadblock.aspx", "Bindprojects", ex.Message, "Not Fixed");
        }
    } 
    ...
    public bool Isalreadyexist(string PID, string Bname)
    {
        ...
        {
            CE.StoreExceptionMessage("bulkuploadblock.aspx", "Isalreadyexist", ex.Message, "Not Fixed");
        }
        return isavail;
    }
