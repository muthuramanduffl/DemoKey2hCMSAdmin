<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-flat-floor-plan.aspx.cs" Inherits="add_flat_floor_plan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div class="input-icon input-icon-sm right">
                                                        ...
                                                        <asp:DropDownList ID="ddlflatNumber" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlflatNumber_SelectedIndexChanged" class="form-control input-sm" runat="server">
                                                            <asp:ListItem Selected="True"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                    <span class="error">
                                            ...
                                            <div class="form-border margin-top20">
                                                ...
                                                <div class="table-responsive pt-4 mt-md-2 mt-0 px-4">
                                                    <asp:Repeater ID="rpruser" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                <asp:HiddenField ID="HiddenField1" Value='<%# Eval("FlatFloorPlanID") %>' runat="server" />
                                                            ...
                                                            <i class="bi bi-eye b5-icon-et-dlt"></i>
                                                                    ...
                                                                    <a href="#" data-bs-toggle="tooltip" title="View" onclick="showImage('<%#"/FlatFloorPlan/"+ Eval("ImagePath") %>'); return false;">
                                                                        <i class="bi bi-eye b5-icon-et-dlt"></i>
                                                                    </a>
                                                                </td>
                                                                <td>
        ...
        function deleteRow(btn) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'add-flat-floor-plan.aspx/DeleteCustomer',
                        ...
                        success: function (response) {
                            ...
                            Swal.fire({
                                title: 'Flat floor plan has been deleted.', confirmButtonText: 'Ok',
                                customClass: {
                                    confirmButton: 'handle-btn-success'
                                },
                            });
    ...
    <script type="text/javascript">
        function loadRepeaterData(selectedValue) {
            $.ajax({
                type: 'POST',
                url: 'add-flat-floor-plan.aspx/GetCostDetails',
                ...
                success: function (response) {
                    if (response && response.d) {
                        ...
                        <td>
                            <a href="#" data-bs-toggle="tooltip" title="View" onclick="showImage('/FlatFloorPlan/${item.ImagePath}'); return false;">
                                <i class="bi bi-eye b5-icon-et-dlt"></i>
                            </a>
                        </td>
                        <td>
        ...
        function setupFileUploader(fileUploaderSelector, viewButtonSelector, labelSelector) {
            ...
            fileUploader.addEventListener('change', function () {
                ...
                if (file) {
                    ...
                    if (size > 1500) {
                        label.textContent = "Image size must be under 1500 KB";
                        resetFileInput();
                        return;
                    }
                    label.textContent = "";
