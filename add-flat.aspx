                                ...
                                <div class="form-border margin-top20">
                                    ...
                                    <div class="row mx-0 margin-top20 mb-4">
                                        ...
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            ...
                                            <span class="error">
                                                <asp:RequiredFieldValidator ClientIDMode="Static" EnableClientScript="true" SetFocusOnError="true" ControlToValidate="ddlFacing" Display="Dynamic" ValidationGroup="projval" ID="RequiredFieldValidator3" runat="server" ErrorMessage="Select facing"></asp:RequiredFieldValidator>
                                            </span>
                                        </div>
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
                                        ...
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
                                                ...
                                                <asp:DropDownList ID="ddlunit" class="bs-select form-control input-sm" runat="server">
                                                    <asp:ListItem Value=""></asp:ListItem>
                                                    <asp:ListItem Value="2 BHK">2 BHK</asp:ListItem>
                                                    <asp:ListItem Value="2.5 BHK">2.5 BHK</asp:ListItem>
                                            ...
                                            <span class="error">
                                                <asp:RequiredFieldValidator ClientIDMode="Static" EnableClientScript="true" SetFocusOnError="true" ControlToValidate="ddlunit" Display="Dynamic" ValidationGroup="projval" ID="RequiredFieldValidator5" runat="server" ErrorMessage="Select unit type"></asp:RequiredFieldValidator>
                                            </span>
                                        </div>
                                        <div class="col-sm-4 col-xl-2 pt-3">
                                            <div class="input-icon input-icon-sm right">
