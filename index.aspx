                ...
                <div class="box loginBox">
                    ...
                    <div class="form">
                        <div class="f_row">
                            ...
                            <asp:TextBox ID="txtusername" CssClass="input-field txt" runat="server"></asp:TextBox>
                            <u></u>
                        ...
                        <div class="f_row last">
                            ...
                            <asp:TextBox ID="txtpassword" TextMode="Password" CssClass="input-field txt" runat="server"></asp:TextBox>
            ...
            $(document).ready(function () {
                ...
                document.addEventListener("keydown", function (event) {
                    if (event.key === "Enter") {
                        ...
                        const textboxes = document.querySelectorAll(".txt");
                        let focused = false;
                        for (let i = 0; i < textboxes.length; i++) {
                            if (textboxes[i].value.trim() === "") {
                                textboxes[i].focus(); 
                                $(textboxes[i]).parent(".f_row").addClass("shake"); 
                                focused = true;
                                break;
                            }
                        }
