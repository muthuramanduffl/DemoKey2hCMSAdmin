...
public partial class adminkey2hcom_ViewReferContent : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { 
            ...
            {
                CI.StoreExceptionMessage("view-refer-content.aspx", "page load", ex.Message, "Not Fixed");
            }
            Bind(0);
        }
    }
    ...
    public void Bind(int pageIndex)
    {
        ...
        {
            CI.StoreExceptionMessage("view-refer-content.aspx", "Bind", ex.Message, "Not Fixed");
        }
