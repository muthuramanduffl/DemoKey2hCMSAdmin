...
public partial class adminkey2hcom_AddPaymentTransaction : System.Web.UI.Page
{
        ...
        if (string.IsNullOrEmpty(labelerror))
        {
            ...
            { 
                ...
                if (ret == 1)
                {
                    ...
                    lbltotalamount.Text = KD.GetPayScheduleTotalAmount(Convert.ToInt32(ddlFlatNumber.SelectedValue));
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("view-payment-transaction.aspx");
        }
    } 
    public void Clear()
    { 
    ...
    { 
        ...
        {
            CI.StoreExceptionMessage("add-payment-transaction.aspx", "FlatFunction", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindtransactionList(int FlatID)
    {
        try
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                divtransactionList.Style.Add("Display", "block");
                lbltotalamount.Text = KD.GetPayScheduleTotalAmount(Convert.ToInt32(ddlFlatNumber.SelectedValue));
                lblpaidamount.Text = KD.GetPaySchedulePaidAmount(Convert.ToInt32(ddlFlatNumber.SelectedValue));
                lblbalanceamount.Text = KD.GetPayScheduleBalanceAmount(Convert.ToInt32(ddlFlatNumber.SelectedValue));
        ...
        {
            CI.StoreExceptionMessage("add-payment-transaction.aspx", "BindtransactionList", ex.Message, "Not Fixed");
        }
    }
