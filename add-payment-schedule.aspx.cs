...
public partial class adminkey2hcom_AddPaymentSchedule : System.Web.UI.Page
{
    ...
    public void Bindblock()
    {
        ...
        {
            CE.StoreExceptionMessage("add-payment-schedule.aspx", "Bindblock", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindFlat()
    {
        ...
        {
            CE.StoreExceptionMessage("add-payment-schedule.aspx", "BindFlat", ex.Message, "Not Fixed");
        }
    }
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("view-payment-schedule.aspx");
        }
    }
    public void Clear()
    { 
                    ...
                    if (ret == 1)
                    {
                            ...
                            percentage > 0)
                        {
                            ...
                            if (dt != null && dt.Rows.Count > 0)
                            {
                                ...
                                int h = KD.GetParameterCostofFlatID(flatnumber, "H");
                                int i = KD.GetParameterCostofFlatID(flatnumber, "I");
                                int j = KD.GetParameterCostofFlatID(flatnumber, "J");
                                int g = KD.GetParameterCostofFlatID(flatnumber, "G");
                                int c = a + b;
                                int subtotal = c + f + g + h + i + j;
