...
public partial class adminkey2hcom_WhatsHappening : System.Web.UI.Page
{
    ...
    public void Bindprojects()
    {
        ...
        {
            CE.StoreExceptionMessage("add-whats-happening.aspx", "Bindprojects", ex.Message, "Not Fixed");
        }
    }
    ...
    { 
        ...
        {
            CE.StoreExceptionMessage("add-whats-happening.aspx", "BindWhatshappening", ex.Message, "Not Fixed");
        }
    }
    ...
    { 
        ...
        {
            CE.StoreExceptionMessage("add-whats-happening.aspx", "AddWhatshappening", ex.Message, "Not Fixed");
        }
        return ret;
    }
    ...
    { 
        ...
        {
            CE.StoreExceptionMessage("add-whats-happening.aspx", "UpdateWhatshappening", ex.Message, "Not Fixed");
        }
        return ret;
    }
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("view-whats-happening.aspx");
        }
    }
    public void Clear()
    {
