<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-quality-reports.aspx.cs" Inherits="adminkey2hcom_AddFloorPlan" %>
                                    ...
                                    <div class="row mx-0 margin-top20 mb-4">
                                        ...
                                        <div class="col-sm-4 col-xl-4 pt-3 ">
                                            <div class="input-icon input-icon-sm right">
                                                ...
                                                <span class="handle-file-request">(max file size of 1500KB)</span>
                                            ...
                                            <div class="form-border margin-top20">
                                                ...
                                                <div class="table-responsive pt-4 mt-md-2 mt-0 px-4">
                                                    <asp:Repeater ID="rpruser" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                <asp:HiddenField ID="HiddenField1" Value='<%# Eval("QPID") %>' runat="server" />
                                                                ...
                                                                <td>
                                                                    <div class="view-pdf btn-view" id="viewPdf<%# Container.ItemIndex %>">
                                                                        <a target="_blank" href='<%# "/QualityReports/"+Eval("PDFName") %>' class="btn-view btnview-pdf" data-bs-toggle="tooltip" title="View">
                                                                            <i class="bi bi-eye b5-icon-et-dlt"></i>
                                                                        </a>
                                                                    </div>

                                                                    <!-- <a href="#" data-bs-toggle="tooltip" title="View" onclick="showImage('<%#"/FloorPlans/"+ Eval("PDFName") %>'); return false;">
                                                                        <i class="bi bi-eye b5-icon-et-dlt"></i>
                                                                    </a>  -->
                                                                </td>
                                                                <td>
    ...
    function deleteRow(btn) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'add-quality-reports.aspx/DeleteCustomer',
