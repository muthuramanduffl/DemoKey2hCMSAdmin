                                        ...
                                        <div class="form-group" id="divtransactionList" style="display: none" clientidmode="Static" runat="server">
                                            <div class="form-border margin-top20">
                                                ...
                                                <div class="pt-5">
                                                    ...
                                                    <h3 style="padding-left: 15px;">Amount Paid : Rs. <asp:Label ID="lblpaidamount" CssClass="error-label" ForeColor="#D41111" runat="server" Text=""></asp:Label> </h3> 


                                                    <h3 style="padding-left: 15px;">Balance Amount : Rs. <asp:Label ID="lblbalanceamount" CssClass="error-label" ForeColor="#D41111" runat="server" Text=""></asp:Label> </h3> 
                                                </div>
