...
{ 
    ...
    public void BindFlat()
    {
        ...
        {
            CI.StoreExceptionMessage("view-flat-booking.aspx", "BindFlat", ex.Message, "Not Fixed");
        }
    }
    ...
    public void DownloadToExcelIntivitualRecordsByflatcustomerID()
    {
        ...
        try
        {
            ...
            if (LoanTable != null && LoanTable.Count > 0)
            {
                ...
                dt1.Columns.Add("Co-Applicant First Name");
                dt1.Columns.Add("Co-Applicant Last Name");
                dt1.Columns.Add("Co-Applicant Gender");
                dt1.Columns.Add("Co-Applicant Date of Birth");
                dt1.Columns.Add("Co-Applicant Email ID");
                dt1.Columns.Add("Co-Applicant Mobile Number 1");
                dt1.Columns.Add("Co-Applicant Mobile Number 2");
                dt1.Columns.Add("Co-Applicant WhatsApp Number");
                dt1.Columns.Add("Co-Applicant Address");
                dt1.Columns.Add("Co-Applicant Residential Status");
                dt1.Columns.Add("Co-Applicant City");
                dt1.Columns.Add("Co-Applicant State");
              
                dt1.Columns.Add("Co-Applicant Postal Code");
                ...
                { 
                    ...
                    if (dobdate != DateTime.MinValue && dobdate != new DateTime(1753, 1, 1))
                    {
                    ...
                    dr1["Bank Name"] = dt.Rows[i]["BankName"].ToString();
                    dr1["Refered By"] = dt.Rows[i]["ReferedBy"].ToString();
                    dr1["Reference"] = dt.Rows[i]["Reference1"].ToString();

                    dr1["Co-Applicant First Name"] = dt.Rows[i]["CoapplicantFirstName"].ToString();
                    dr1["Co-Applicant Last Name"] = dt.Rows[i]["CoapplicantLastName"].ToString();
                    dr1["Co-Applicant Gender"] = dt.Rows[i]["CoaGender"].ToString();
                    
                    DateTime CoApplicantDateofBirth = Convert.ToDateTime(dt.Rows[i]["CoDOB"]);

                    if (CoApplicantDateofBirth != DateTime.MinValue && CoApplicantDateofBirth != new DateTime(1753, 1, 1))
                    {
                        dr1["Co-Applicant Date of Birth"] = CoApplicantDateofBirth.ToString("dd/MM/yyyy");
                    }
                    else
                    {
                        dr1["Co-Applicant Date of Birth"] = "";
                    }
                    dr1["Co-Applicant Email ID"] = dt.Rows[i]["CoaEmailID"].ToString();
                    dr1["Co-Applicant Mobile Number 1"] = dt.Rows[i]["CoaMobilenumber1"].ToString();
                    dr1["Co-Applicant Mobile Number 2"] = dt.Rows[i]["CoaMobilenumber2"].ToString();
                    dr1["Co-Applicant WhatsApp Number"] = dt.Rows[i]["CoaWhatsappNumber"].ToString();
                    dr1["Co-Applicant Address"] = dt.Rows[i]["CoaAddress"].ToString();
                    dr1["Co-Applicant Residential Status"] = dt.Rows[i]["CoaResidentialStatus"].ToString();

                    dr1["Co-Applicant City"] = Bindcity(Convert.ToInt32(dt.Rows[i]["CoaCityID"]));
                    dr1["Co-Applicant State"] = BindState(Convert.ToInt32(dt.Rows[i]["CoaStateID"]));
                    dr1["Co-Applicant Postal Code"] = dt.Rows[i]["CoaPinCode"].ToString();
                    ...
                    if (paodatedtDate != DateTime.MinValue && paodatedtDate != new DateTime(1753, 1, 1))
                    {
                    ...
                    if (BookingdtDate != DateTime.MinValue && BookingdtDate != new DateTime(1753, 1, 1))
                    {
                    ...
                    if (regdtDate != DateTime.MinValue && regdtDate != new DateTime(1753, 1, 1))
                    {
                    ...
                    if (dtDate != DateTime.MinValue && dtDate != new DateTime(1753, 1, 1))
                    {
        ...
        {
            //CI.StoreExceptionMessage("view-flat-booking.aspx", "DownloadToExcelIntivitualRecordsByflatcustomerID", ex.Message, "Not Fixed");
        }
    }
    ...
    public string leadSourcename(int ID)
    {
        ...
        {
            CI.StoreExceptionMessage("view-flat-booking.aspx", "leadSourcename", ex.Message, "Not Fixed");
        }
        return strlread;
    }
