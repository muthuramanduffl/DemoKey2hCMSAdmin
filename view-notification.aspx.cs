...
public partial class adminkey2hcom_ViewBroadcast : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                CI.StoreExceptionMessage("view-notification.aspx", "Page_Load", ex.Message, "Not Fixed");
            }
            Bind(0);
        }
    }
    ...
    public void Bind(int pageIndex)
    {
        ...
        {
            CI.StoreExceptionMessage("view-notification.aspx", "Bind", ex.Message, "Not Fixed");
        }
    }
    ...
    public string Bindprojectname(int Prid)
    {
        ...
        {
            CI.StoreExceptionMessage("view-notification.aspx", "Bindprojectname", ex.Message, "Not Fixed");
        }
        return strname;
    }
    ...
    public DataTable Get()
    {
        ...
        try
        {
            ...
            {
                dt = KF.ViewAllNotifications(ddlprojects.SelectedValue);
            }
            else
            {
                dt = KF.ViewAllNotifications("");
            }
        }
        catch (Exception ex)
        {
            CI.StoreExceptionMessage("view-notification.aspx", "Get", ex.Message, "Not Fixed");
        }
        return dt;
    }
