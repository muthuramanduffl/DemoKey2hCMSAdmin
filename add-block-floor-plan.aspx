<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-block-floor-plan.aspx.cs" Inherits="add_flat_floor_plan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                            ...
                                            <div class="form-border margin-top20">
                                                ...
                                                <div class="table-responsive pt-4 mt-md-2 mt-0 px-4">
                                                    <asp:Repeater ID="rpruser" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                <asp:HiddenField ID="HiddenField1" Value='<%# Eval("BlockFloorPlanID") %>' runat="server" />
                                                            ...
                                                            <i class="bi bi-eye b5-icon-et-dlt"></i>
                                                                    ...
                                                                    <a href="#" data-bs-toggle="tooltip" title="View" onclick="showImage('<%#"/BlockFloorPlan/"+ Eval("ImagePath") %>'); return false;">
                                                                        <i class="bi bi-eye b5-icon-et-dlt"></i>
                                                                    </a>
                                                                </td>
                                                                <td>
        ...
        function deleteRow(btn) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var dropflatname = document.getElementById('<%= ddlblocknumber.ClientID %>');
                    var selectedValue = dropflatname ? dropflatname.value : '';

                    $.ajax({
                        type: 'POST',
                        url: 'add-block-floor-plan.aspx/DeleteCustomer',
                        ...
                        success: function (response) {
                            ...
                            Swal.fire({
                                title: 'Block floor plan has been deleted.', confirmButtonText: 'Ok',
                                customClass: {
                                    confirmButton: 'handle-btn-success'
                                },
                            });
    ...
    <script type="text/javascript">
        function loadRepeaterData(selectedValue) {
            $.ajax({
                type: 'POST',
                url: 'add-block-floor-plan.aspx/GetCostDetails',
                ...
                success: function (response) {
                    if (response && response.d) {
                        ...
                        <td>
                            <a href="#" data-bs-toggle="tooltip" title="View" onclick="showImage('/BlockFloorPlan/${item.ImagePath}'); return false;">
                                <i class="bi bi-eye b5-icon-et-dlt"></i>
                            </a>
                        </td>
                        <td>
