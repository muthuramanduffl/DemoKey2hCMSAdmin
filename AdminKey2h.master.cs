...
public partial class adminkey2com_AdminKey2h : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (currentPage.Contains("add-customization-work-approval.aspx"))
        {
            tabCust.Attributes["class"] = "nav-link active";
            subMenuAddCWA.Attributes["class"] = "active";
        ...
        else if (currentPage.Contains("add-block-floor-plan.aspx"))
        {
            tabMore.Attributes["class"] = "nav-link active";
            subMenuAddFBP.Attributes["class"] = "active";
            tab4.Attributes["class"] = "tab-pane fade active show";
            tab1.Attributes["class"] = "tab-pane fade";
            tab3.Attributes["class"] = "tab-pane fade";
            tab2.Attributes["class"] = "tab-pane fade";
        ...
        else if (currentPage.Contains("add-flat-floor-plan.aspx"))
        {
            tabMore.Attributes["class"] = "nav-link active";
            subMenuAddFFP.Attributes["class"] = "active";
            tab4.Attributes["class"] = "tab-pane fade active show";
            tab1.Attributes["class"] = "tab-pane fade";
            tab3.Attributes["class"] = "tab-pane fade";
            tab2.Attributes["class"] = "tab-pane fade";
        ...
        {
            tabMore.Attributes["class"] = "nav-link active";
            subMenuViewFBP.Attributes["class"] = "active";
            tab4.Attributes["class"] = "tab-pane fade active show";
            tab1.Attributes["class"] = "tab-pane fade";
            tab3.Attributes["class"] = "tab-pane fade";
            tab2.Attributes["class"] = "tab-pane fade";
        ...
        else if (currentPage.Contains("view-flat-floor-plan.aspx"))
        {
            tabMore.Attributes["class"] = "nav-link active";
            subMenuViewFFP.Attributes["class"] = "active";
            tab4.Attributes["class"] = "tab-pane fade active show";
            tab1.Attributes["class"] = "tab-pane fade";
            tab3.Attributes["class"] = "tab-pane fade";
            tab2.Attributes["class"] = "tab-pane fade";
        ...
        else if (currentPage.Contains("view-notification.aspx"))
        {
            tabMore.Attributes["class"] = "nav-link active";
            subMenuViewNoti.Attributes["class"] = "active";
            tab4.Attributes["class"] = "tab-pane fade active show";
            tab1.Attributes["class"] = "tab-pane fade";
            tab3.Attributes["class"] = "tab-pane fade";
            tab2.Attributes["class"] = "tab-pane fade";
        ...
        else if (currentPage.Contains("add-amenities.aspx"))
        {
            tabMore.Attributes["class"] = "nav-link active";
            subamenities.Attributes["class"] = "active";
            tab4.Attributes["class"] = "tab-pane fade active show";
            tab1.Attributes["class"] = "tab-pane fade";
            tab3.Attributes["class"] = "tab-pane fade";
            tab2.Attributes["class"] = "tab-pane fade";
