...
public partial class adminkey2hcomaddflat : System.Web.UI.Page
{
    ...
    public void Bind(int id)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    ddlunit.SelectedValue = Convert.ToString(dt.Rows[0]["UnitType"]);
                }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (string.IsNullOrEmpty(ddlunit.SelectedValue))
            {
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("view-flat.aspx");
        }
    }
    public int AddData()
    {
        ...
        try
        {
            ...
            KF.UDS = txtUDS.Text;
            KF.UnitType = ddlunit.SelectedValue;
