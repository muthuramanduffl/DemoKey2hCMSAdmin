...
public partial class adminkey2hcomaddflatprogress : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (ProgressID != null && !string.IsNullOrEmpty(Convert.ToString(ProgressID)))
                {
        ...
        {
            CI.StoreExceptionMessage("add-flat-progress.aspx", "btnsubmit", ex.Message, "Not Fixed");
        }
    }
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("view-flat-progress.aspx");
        }
    }
    public int AddData()
    {
    ...
    public static List<CostDetail> GetCostDetails(string selectedValue)
    {
        ...
        {
            if (LoginIDCookie.Value.Contains("clientid="))
            {
                strClientID = LoginIDCookie.Value.Replace("clientid=", "").Trim();
            }
            else
            {
                strClientID = LoginIDCookie.Value.Trim();
            }
        }
        else
        {
