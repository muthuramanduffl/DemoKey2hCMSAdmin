...
public partial class adminkey2hcom_AddKYCDocs : System.Web.UI.Page
{
    ...
    public void Bind(string id)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(dt.Rows[0]["DriveLink"].ToString()) && dt.Rows[0]["DriveLink"] != null)
                {
                    txtLink.Text = dt.Rows[0]["DriveLink"].ToString();
                }
    ...
    public void FlatFunction()
    {
        ...
        {
            CE.StoreExceptionMessage("add-kyc-docs.aspx", "FlatFunction", ex.Message, "Not Fixed");
        }
    }
    ...
    public int AddData()
    {
        ...
        try
        {
            ...
            KYC.strdrivelink = txtLink.Text.Trim();
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("view-kyc-docs.aspx");
        }
    }
    public void Clear()
    {
