...
public partial class adminkey2hcom_AddCostDetails : System.Web.UI.Page
{
    ...
    Key2hPaymentDetails KE = new Key2hPaymentDetails();
    ...
    public void Bind(string ID)
    {
        ...
        {
            CE.StoreExceptionMessage("add-cost-details.aspx", "Bind ViewAllFlatCostDetails", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindFlatID(string ID)
    {
        ...
        {
            CE.StoreExceptionMessage("add-cost-details.aspx", "BindFlatID", ex.Message, "Not Fixed");
        }
    }
    ...
    public void BindCostDetails(int ID)
    {
        try
        {
            lbltotalamount.Text = KE.GetPayScheduleTotalAmount(ID);
    ...
    { 
        ...
        {
            Response.Redirect("view-cost-details.aspx");
        }
    }
