                ...
                { 
                    if (FluploadProjectScreen.HasFile)
                    {
                        ...
                        if (isave > 0)
                        {
                            ...
                            "Swal.fire({ " +
                        "  title: 'Flat details uploaded successfully', " +
                        "  icon: 'success', " +
                        "  customClass: { " +
    ...
    public int SaveDetails(List<string> lstHeader, DataTable dt)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                stCarparkingCount = dt.Rows[i][lstHeader[CarparkingCountIndex]] != null 
                    ? dt.Rows[i][lstHeader[CarparkingCountIndex]].ToString().Trim() 
                    : string.Empty;
                ...
                { 
                    ...
                    { 
                        ...
                        int carparkingCount;
                        KF.CarparkingCount = int.TryParse(stCarparkingCount, out carparkingCount) ? carparkingCount : 0;
