...
public partial class adminkey2hcom_AddFlatBooking1 : System.Web.UI.Page
{
...
public static void sendMail(string subject, string body, string stTomail)
{
    ...
    // {
        SmtpClient smtpClient = new SmtpClient("smtp.gmail.com")
        {
            ...
            Credentials = new NetworkCredential("support@themindandcompany.com", "wztu mboe niqc yxlc"),
            EnableSsl = true
        };

        MailMessage message = new MailMessage
        {
            From = new MailAddress("support@themindandcompany.com", "Key2H"),
            Subject = subject,
            Body = body,
            IsBodyHtml = true
        };
