<%@ Page Title="" Language="C#" MasterPageFile="AdminKey2h.master" AutoEventWireup="true" CodeFile="add-flat-quality-reports.aspx.cs" Inherits="add_flat_quality_reports " %>
                            ...
                            <div class="form-group">
                                <div class="form-border margin-top20">
                                    ...
                                    <div class="row mx-0 margin-top20 mb-4">
                                        ...
                                        <div class="col-sm-4 col-xl-3 pt-3">
                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server" RenderMode="Block" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                <contenttemplate>
                                                    <div class="input-icon input-icon-sm right">
                                                    ...
                                                    <span class="error">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator29" Display="Dynamic" runat="server" InitialValue="" ControlToValidate="ddlblocknumber" ValidationGroup="projval" ErrorMessage="Select block name"></asp:RequiredFieldValidator>
                                                    </span>
                                                </contenttemplate>
                                                <triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="ddlProName" EventName="SelectedIndexChanged" />
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                                <contenttemplate>
                                                    <div class="input-icon input-icon-sm right">
                                                        ...
                                                        <asp:DropDownList ID="ddlflatNumber" ClientIDMode="Static" OnSelectedIndexChanged="ddlflatNumber_SelectedIndexChanged" AutoPostBack="true" class="form-control input-sm" runat="server">
                                                            <asp:ListItem Selected="True"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                    <span class="error">
                                        ...
                                        <div class="col-sm-4 col-xl-4 pt-3 ">
                                            <div class="input-icon input-icon-sm right">
                                                <label>PDF Upload <span class="text-danger">*</span></label>
                                                <i class="bi bi-images b5-icon"></i>
                                                <asp:FileUpload ID="FluploadImageUpload" ClientIDMode="Static" accept=".pdf" onchange="showMyImage1(this)" class="form-control input-sm FluploadImageUpload" autocomplete="off" placeholder="" runat="server" />
                                            ...
                                            <span class="error">
                                                <asp:RequiredFieldValidator EnableClientScript="true" SetFocusOnError="true" ControlToValidate="FluploadImageUpload" ValidationGroup="projval" ID="RequiredFieldValidator2" runat="server" ErrorMessage=" Upload pdf "></asp:RequiredFieldValidator>
                                            </span>
                                            ...
                                            <div class="form-border margin-top20">
                                                ...
                                                <div class="table-responsive pt-4 mt-md-2 mt-0 px-4">
                                                    <asp:Repeater ID="rpruser" runat="server">
                                                        ...
                                                        <itemtemplate>
                                                            <tr>
                                                                <asp:HiddenField ID="HiddenField1" Value='<%# Eval("QFID") %>' runat="server" />
                                                                ...
                                                                <td>
                                                                    <div class="view-pdf btn-view" id="viewPdf<%# Container.ItemIndex %>">
                                                                        <a target="_blank" href='<%# "/FlatQualityReportDoc/"+Eval("PDFName") %>' class="btn-view btnview-pdf" data-bs-toggle="tooltip" title="View">
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            function initializeFileUpload() {
                ...
                var errorLabel = document.querySelector('.lblflFQUpload');
        ...
        function deleteRow(btn) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'add-flat-quality-reports.aspx/DeleteCustomer',
        ...
        function showMyImage1(fileInput) {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                if (allowedFiles.includes("." + ext)) {
                    ...
                    lbl.textContent = "Select .pdf files only.";
                    resetFileInput(fileInput);
                    //resetImageDisplay();
                }
            }
