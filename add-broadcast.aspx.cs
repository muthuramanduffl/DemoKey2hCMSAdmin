...
public partial class adminkey2hcom_AddBroadcast : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lbldisplaytext.Text = "Send Broadcast Messages";
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(Labelerror))
        {
            ...
            else
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                    "Swal.fire({ " +
                    "  title: 'Broadcast details couldn't be added due to a server or network issue. Please try again in some time!', " +
    ...
    public int AddBroadcast()
    {
        ...
        {
            CI.StoreExceptionMessage("add-broacast.aspx", "BindFlat", ex.Message, "Not Fixed");
        }
        return ret;
    }
    public void Clear()
