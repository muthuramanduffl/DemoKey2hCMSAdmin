...
public partial class adminkey2hcom_Specifications : System.Web.UI.Page
{
    ...
    public void Bindprojects()
    {
        ...
        {
            CI.StoreExceptionMessage("add-specifications.aspx", "Bindprojects", ex.Message, "Not Fixed");
        }
    }
...
private string GenerateHTML(DataTable dt)
{
    ...
    public int SaveDetails(List<string> lstHeader, DataTable dt)
    {
        ...
        {
            CI.StoreExceptionMessage("add-specifications.aspx", "SaveDetails", ex.Message, "Not Fixed");
        }
        return iSave;
    }
