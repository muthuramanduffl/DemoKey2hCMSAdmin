...
public class Key2hCustomer
{
    ...
    public string strEmailID { get; set; }
     public string FlatLoginCode { get; set; }
    ...
    public int AddFlatCustomerBookingDetails(Key2hCustomer KC)
    {
        ...
        try
        {
            using (SqlCommand command = new SqlCommand("AddFlatCustomerBookingDetails", cnn))
            {
                ...
                command.Parameters.Add(new SqlParameter("@FlatLoginCode", KC.FlatLoginCode));
    ...
    public DataSet GetFlatLoginCodebyProjectID(int ProjectID)
    {
        string connetionString = null;
        SqlConnection cnn;
        connetionString = GetSqlConnection();
        ...
        try
        {
            using (SqlCommand command = new SqlCommand("ViewFlatLoginCodebyProjectID", cnn))
            {
                cnn.Open();
                command.CommandType = CommandType.StoredProcedure;
