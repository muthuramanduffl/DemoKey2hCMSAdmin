...
public class Key2hPaymentDetails
{
    ...
    public string GetPayScheduleTotalAmount(int ID)
    {
        ...
        using (SqlCommand command = new SqlCommand("GetPayScheduleTotalAmount", cnn))
        {
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.Add(new SqlParameter("@FlatID", ID));
    ...
    public string GetPaySchedulePaidAmount(int ID)
    {
        string totalAmount = "0"; 
        try
        {
        string connectionString = GetSqlConnection();
        using (SqlConnection cnn = new SqlConnection(connectionString))
        using (SqlCommand command = new SqlCommand("GetPaySchedulePaidAmount", cnn))
        {
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.Add(new SqlParameter("@FlatID", ID));
    ...
    public string GetPayScheduleBalanceAmount(int ID)
    {
        string totalAmount = "0"; 
        try
        {
        string connectionString = GetSqlConnection();
        using (SqlConnection cnn = new SqlConnection(connectionString))
        using (SqlCommand command = new SqlCommand("GetPayScheduleBalanceAmount", cnn))
        {
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.Add(new SqlParameter("@FlatID", ID));
