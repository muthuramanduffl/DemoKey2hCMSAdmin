...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <div class="form-group">
                                <div class="form-border margin-top20">
                                    <div class="form-title">
                                        <h3>Customization Demand Details</h3>
                                    </div>
        ...
        function deleteRow(btn) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'add-customization-demand.aspx/DeleteCustomisationDemands',
            ...
            function initializeFileUpload() {
                ...
                fileUploader.addEventListener('change', function (event) {
                    ...
                    if (file.size > 1500 * 1024) { // 800 KB
                        resetUploader();
                        errorLabel.textContent = "FIle size must be less than 1500 KB";
                        return;
                    }
    ...
    <script type="text/javascript">
        function loadRepeaterData(selectedValue) {
            $.ajax({
                type: 'POST',
                url: 'add-customization-demand.aspx/GetCostDetails',
